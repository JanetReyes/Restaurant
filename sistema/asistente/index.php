  ...
  <!-- Sidebar -->
        <div id="sidebar-wrapper">
            <ul class="sidebar-nav">
				...
				<li>
                    <a href="#" onclick="load_div('contenido', 'pedido/pedido_pre.php');" style="cursor:pointer"><span class="glyphicon glyphicon-glyphicon glyphicon-list-alt" aria-hidden="true">&nbsp;REG.PEDIDO</span></a>
                </li>
